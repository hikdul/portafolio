...
const DataIconLB = ({ name, desc, icon }: dataIconLBProps) => {
    return (
        <div className="group miniMeCard flex flex-row justify-evenly border-2 rounded border-transparent hover:border-[#333] mx-1.5 hover:bg-green-400 duration-500   ">
